...
const UNIT_DETAILS_AREA = document.createElement("div");

// Style the UNIT_DETAILS_AREA element
UNIT_DETAILS_AREA.style.backgroundColor = "#ffff80";
UNIT_DETAILS_AREA.style.width = "maxcontent";
UNIT_DETAILS_AREA.style.height = "maxcontent";
UNIT_DETAILS_AREA.style.padding = "10px";
UNIT_DETAILS_AREA.style.position = "absolute";
UNIT_DETAILS_AREA.style.right = "10px";
UNIT_DETAILS_AREA.style.bottom = "10px";
UNIT_DETAILS_AREA.style.fontWeight = "bold";
UNIT_DETAILS_AREA.style.borderRadius = "8px";
UNIT_DETAILS_AREA.style.fontSize = "20px";
UNIT_DETAILS_AREA.setAttribute("className", "unit_cost_detail");
UNIT_DETAILS_AREA.innerHTML = `<pre><h3 style = "justify-self: center; color: red;">Unit Cost Detail</h3> <p>0 to 50 Unit      : ${per_unit_0_to_50}</p> <p>51 to 150 Unit    : ${per_unit_51_to_150}</p> <p>151 to 250 Unit   : ${per_unit_151_to_250}</p> <p>251 to above Unit : ${per_unit_251_to_above}</p></pre>`;

// Get the whole page element and add the element
const FULL_PAGE = document.getElementsByClassName("main_container")[0];
FULL_PAGE.append(UNIT_DETAILS_AREA);
